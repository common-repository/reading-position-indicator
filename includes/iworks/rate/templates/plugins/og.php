...
<p>
<?php
	esc_html_e( 'Would you like to boost your website sharing abilities?', 'reading-position-indicator' );
?>
</p>
<p>
<?php
...
/* translators: %s is a plugin name with url */
	esc_html__( 'Don\'t wait, install plugin %s!', 'reading-position-indicator' ),
...
"><?php echo esc_html( __( 'Install', 'reading-position-indicator' ) ); ?></a></p>
